...
* Im Post alle Bilder eines Sets am Ende des Beitrags in 2 Spalten anzeigen -> 
  ...
  dann in selbigem im yaml format datei nach folgendem Schema erstellen;
    - |
        dummy um reihenfolge zu bewahren
        jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj
    - | 
        <b>Ankunft Camping du Lac</b>  
    - 
    - |     
        <b>Unser Platz an der Sonne</b>
   
    wobei <- |> für je 1 Bild steht. Wenn kein kommentar benötigt wird entfaellt der <|> aber der <-> muss pro Bild vorhanden sein um die Reihenfolge zu gewährleisten. ab dem letzten Bild mit Kommentar muß kein < |> mehr eingefügt werden 
...
In FrontMatter: // hinzugegügt Michael Fischer
xstart = 1 //setzt den Artikel auf die Start Seite 
show_diagramm: 1 // laedt pgn4web.js in den post
image_p:    // laedt anderes Bild als auf der Kategorieübersicht in den Artikel z.B  image_p: schacharena.pngschacharena.png
